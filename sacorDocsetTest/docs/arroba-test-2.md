...
Комментируя панель мониторинга или конкретный визуальный элемент, вы можете привлечь внимание коллег с помощью символа "@".
При вводе **@**, Power BI открывает раскрывающийся список, где можно найти и выбрать пользователей из вашей организации.
